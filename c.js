window.TAB = "    ";
window.ImgCollapsed = "image/Collapsed.gif";
...
function Process(){
  ...
  try{
    ...
    //var obj = eval("["+json+"]");
    html = ProcessObject(JSON.parse(json), 0, false, false, false);
...
function ProcessObject(obj, indent, addComma, isArray, isPropertyContent){
  ...
  if(IsArray(obj)){
    if(obj.length == 0){
      ...
      clpsHtml = window.IsCollapsible ? "<span><img src=\""+window.ImgExpanded+"\" class=expandimg /></span><span class='collapsible' >" : "";
...
function EnsureIsPopulated(){
  ...
  if(!$id("Canvas").innerHTML && !!proxyData) Process();
